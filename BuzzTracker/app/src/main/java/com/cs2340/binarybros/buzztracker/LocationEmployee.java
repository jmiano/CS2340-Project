...
public class LocationEmployee extends User {
    ...
    public LocationEmployee(String nameInput, String usernameInput, String passwordInput,
                 String emailInput, int employeeID, int storeNumber) {
        super(nameInput, usernameInput, passwordInput, emailInput);
        this.employeeNumber = employeeID;
        this.employeeLocation = storeNumber;
    }
